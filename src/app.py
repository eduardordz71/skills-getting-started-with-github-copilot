...
activities.update({
    ...
    "Swimming Team": {
        ...
        "max_participants": 25,
        "participants": ["laura@mergington.edu", "mike@mergington.edu"]
    },
    "Art Club": {
